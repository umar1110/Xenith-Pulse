function Footer() {
  return (
    <div className="w-[80%] bg-black mx-auto flex flex-col items-center space-y-2   py-8 md:w-[60%] ">
      ...
      {/* \section 2 */}
      <div className="part-2-footer w-full text-center space-y-5  lg:flex lg:space-x-3 lg:pt-6 justify-between ">
        <input
          type="email"
          name="Email"
          id="emai"
          className="bg-[#333333] text-xl w-ful px-6 text-white rounded-2xl lg:w-1/2 "
        ...
        <button
          ...
          className="w-[80%] text-xl font-bold rounded-full py-4 text-center lg:w-[30%] "
        >
          Get in touch
        </button>
      </div>
